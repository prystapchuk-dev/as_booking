...
<x-layout>
    ...
    <x-header-layout>
                ...
                <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col lg:text-base mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <a href="#" class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900" aria-current="page">Зареєструвати своє помешкання</a>
                        </li>
                        <li>
                            <a href="{{ route('register') }}" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Зареєструватися</a>
                        </li>
                        <li>
                            <a href="" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Увійти</a>
                        </li>
                    </ul>
                </div>
    </x-header-layout>
<section>
        <div class="container px-6 py-16 mx-auto text-center">
            ...
            <div class="min-w-md mx-auto">
                <div class="w-4/5 mx-auto mb-4">
                    <h1 class="lg:text-5xl font-bold text-gray-800 dark:text-white md:text-4xl">Знайдіть помешкання для наступної подорожі</h1>
                    <p class="mt-6 text-2xl text-gray-500 dark:text-gray-300">
