<x-layout>
    ...
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <svg class="mx-auto w-14 h-14 text-indigo-600"
                     fill="currentColor"
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Створити акаунт</h2>
            </div>
            <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        <label for="name" class="sr-only">І'мя</label>
                    ...
                    <div>
                        <label for="password_confirmation" class="sr-only">Підтвердження паролю</label>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">Увійти</a>
                    </div>
                </div>
