    ...
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Увійти в акаунт</h2>
            </div>
            @if ($errors->any())
            ...
            @endif
            <form class="mt-8 space-y-6" action="{{ route('partner_login') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('register') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> Реєстрація </a>
                    </div>
                </div>
